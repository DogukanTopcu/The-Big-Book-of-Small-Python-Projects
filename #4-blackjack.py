...
def getBet(maxBet):
    # Ask the player how much they want to bet fır this round.
    while True:
...
def displayHands(playerHand, dealerHand, showDealerHand):
    ...
    print()
    if showDealerHand:
        print("DEALER:", getHandValue(playerHand))
...
def getHandValue(cards):
    ...
    # Add the vlue for the non-ace cards:
    for card in cards:
...
def getMove(playerHand, money):
    ...
    while True: # Keep looping until the player enters a correct move.
        ...
        # The player can double down on their first move, which we can tell becaues they will have exactly two cards:
